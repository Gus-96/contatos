...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { numero: @telefone.numero, pessoa_id: @telefone.pessoa_id, tipo: @telefone.tipo } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { numero: @telefone.numero, pessoa_id: @telefone.pessoa_id, tipo: @telefone.tipo } }
